...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                    <a class="sidebar-brand brand-logo text-center" href="index.php"><img id="mainlogo" src="/mosque/admin/assets/images/logo.png" alt="logo"/></a>
                    <a class="sidebar-brand brand-logo-mini" href="index.php"><img id="minilogo" src="/mosque/admin/assets/images/logo-mini.png" alt="logo" /></a>
                </div>
                <ul class="nav">
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="forms.php"> <span class="menu-icon"> <i class="mdi mdi-file-document-box"></i> </span> <span class="menu-title">Forms</span> </a>
                    </li>
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="donations.php"> <span class="menu-icon"> <i class="mdi mdi-chart-bar"></i> </span> <span class="menu-title">Donations</span> </a>
                    </li>
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="trial_balance.php"> <span class="menu-icon"> <i class="mdi mdi-table-large"></i> </span> <span class="menu-title">Trail Balance</span> </a>
                    </li>
                    <li class="nav-item menu-items">

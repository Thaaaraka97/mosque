                ...
                <div class="card-body">
                  ...
                  <form class="pt-3">
                    <div class="form-group">
                      <label for="inputAddress">Name of the Child </label>
                      ...
                      <div class="form-group col-md-6">
                        <div class="form-group row pt-3">
                          ...
                          <div class="col-md-2 pt-2 d-flex align-items-center text-right">
                            <label class="form-label ml-auto">Sex</label>
                          </div>
                          <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="inputAddress3" placeholder="Town">
                    </div>

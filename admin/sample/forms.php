        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-3 grid-margin">
              <div class="card text-center text-dark shadow-sm" style="height : 100%;">
                <div class="card-body">
                  <img src="/mosque/admin/assets/images/icons/shop.png" alt="Trustee Board">

                  <h5 class="card-title mt-3">Rental Details</h5>
                  <a href="/mosque/admin/rental-details-form.php" class="btn btn-primary py-3 mt-3">Open..</a>
                </div>
              </div>
            </div>
            <div class="col-md-3 grid-margin">
          ...
          <div class="row">
            ...
            <div class="col-md-3 grid-margin">
              <div class="card text-center text-dark shadow-sm" style="height : 100%;">
                <div class="card-body">
                  <img src="/mosque/admin/assets/images/icons/member.png" alt="Trustee Board">

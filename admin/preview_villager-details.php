                                                            ...
                                                            foreach ($all_villagers_details as $all_villagers_details_item) {
                                                                if (isset($all_villagers_details_item['av_index'])) {
                                                                    ...
                                                                    echo "
                                                                        ...
                                                                        <td class='pl-3'>
                                                                            <a href='preview_villager-details_step-2.php?index=" . $index . "&subdivision=" . $subdivision . "&action=view_saandha&sort5=" .date('Y-m-01'). "&sort6=" .date('Y-m-t'). "' class='item'><i class='fa fa-eye fa-lg' aria-hidden='true'></i></a>

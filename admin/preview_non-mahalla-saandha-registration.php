                                                    ...
                                                    foreach ($non_mahalla_reg as $non_mahalla_reg_item) {
                                                        ...
                                                        echo "
                                                         <tr>
                                                            ...
                                                            <td>" . $address . "</td>
                                                            <td>
                                                                <a href='preview_non-mahalla-saandha-registration_step-2.php?action=view&id=" . $id . "' class='btn btn-primary btn-md' >View</a>
                                                                <a href='' id ='".$id."' class='btn btn-warning btn-md edit_nonmahalla_saandha_reg' data-toggle='modal' data-target='#updateRecord'>Edit</a>
                                                            </td>
                                                        </tr>
                                                         ";
                                                    }
